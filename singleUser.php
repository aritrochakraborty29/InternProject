...
<body>
		...
		<?php 
			...
			if($_SERVER["REQUEST_METHOD"]=='POST'){
			    ...
			    $disabled="disabled";
			       ...
			       echo "<h4>Account Number: {$customer['c_id']}</h4>";
	...
	<div class="container center">
		<a href="transfer.php" style="background-color: #6C63FF; margin: 20px;" class="btn-1 <?php if($insufficient) { echo $disabled;} ?>">Transfer to &rarr;</a>
		<a href="selectUser.php" class="btn-1">Back</a>
	<div>
	</section>
